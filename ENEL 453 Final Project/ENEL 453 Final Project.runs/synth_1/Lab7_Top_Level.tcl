...
synth_design -top Lab7_Top_Level -part xc7a35tcpg236-1
...
write_checkpoint -force -noxdef Lab7_Top_Level.dcp
OPTRACE "write_checkpoint" END { }
OPTRACE "synth reports" START { REPORT }
generate_parallel_reports -reports { "report_utilization -file Lab7_Top_Level_utilization_synth.rpt -pb Lab7_Top_Level_utilization_synth.pb"  } 
