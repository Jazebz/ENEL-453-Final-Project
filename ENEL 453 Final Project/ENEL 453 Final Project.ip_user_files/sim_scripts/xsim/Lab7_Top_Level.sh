...
#
# Script generated by Vivado on Fri Dec 05 01:53:15 -0700 2025
# SW Build 5239630 on Fri Nov 08 22:35:27 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : Lab7_Top_Level.sh
...
#
# Usage        : Lab7_Top_Level.sh
#                Lab7_Top_Level.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                Lab7_Top_Level.sh [-reset_run]
#                Lab7_Top_Level.sh [-reset_log]
#                Lab7_Top_Level.sh [-help]
#
...
# script info
echo -e "Lab7_Top_Level.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./Lab7_Top_Level.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L xpm -L uvm -L unisims_ver -L unimacro_ver -L secureip --snapshot Lab7_Top_Level xil_defaultlib.Lab7_Top_Level xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim Lab7_Top_Level -key {Behavioral:sim_1:Functional:Lab7_Top_Level} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb Lab7_Top_Level.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./Lab7_Top_Level.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: Lab7_Top_Level.sh [-help]\n\
Usage: Lab7_Top_Level.sh [-step]\n\
Usage: Lab7_Top_Level.sh [-lib_map_path]\n\
Usage: Lab7_Top_Level.sh [-reset_run]\n\
Usage: Lab7_Top_Level.sh [-reset_log]\n\
Usage: Lab7_Top_Level.sh [-keep_index]\n\
Usage: Lab7_Top_Level.sh [-noclean_files]\n\n\
